                        ...
                        <div class="product-detail accordion-detail">
                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="product-detail-rating">
                                            ...
                                            <div class="product-rate-cover text-end">
                                                ...
                                                <span class="font-small ml-5 text-muted"> ({{$product->orderDetails->where('rstatus',1)->count()}} reviews)</span>
                                            </div>
                                        </div>
                                        ...
                                        <ul class="product-meta font-xs color-grey mt-50">
                                            ...
                                            <li>Availability:<span class="in-stock text-success ml-5">{{$product->quantity}} Available</span></li>
                                        </ul>
                                    </div>
                                    <!-- Detail Info -->
                                </div>
                            ...
                            <div class="tab-style3">
                                <ul class="nav nav-tabs text-uppercase">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="Reviews-tab" data-bs-toggle="tab" href="#Reviews">Reviews ({{$product->orderDetails->where('rstatus',1)->count()}})</a>
                                    </li>
                                </ul>

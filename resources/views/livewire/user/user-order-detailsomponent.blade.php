                                  ...
                                  <div class="row d-flex align-items-center">
                                    ...
                                    <div class="col-md-10">
                                      <div class="progress" style="height: 6px; border-radius: 16px;">
                                        <div class="progress-bar" role="progressbar" style="width:{{ $order->status_delivery == 'accept order' ? 30 : ($order->status_delivery == 'delivering' ? 60 : 10) }}%; border-radius: 16px; background-color: #a8729a;" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                                      </div>
